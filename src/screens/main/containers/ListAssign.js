...
const styles = StyleSheet.create({
    containerHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 24 },
    containerBtnTopUp: { flexDirection: "row", alignItems: "center", paddingVertical: 6, width: 92, borderRadius: 2, opacity: 4, justifyContent: "center" },
    txtHeader: { fontSize: 16, fontWeight: "bold", color: Color.grey, marginRight: 16 },
    containerItem: { flex: 1, paddingHorizontal: 24, paddingVertical: 12, backgroundColor: Color.transparent, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
                ...
                <Container>
                    <View style={styles.containerHeader}>
                        ...
                        <TouchableOpacity onPress={() => this.pressPick()}>
                            <View style={[styles.containerBtnTopUp, { backgroundColor: this.changeButton() }]}>
                                <Image source={Images.icon.iconCart} style={{ width: 16, height: 16, resizeMode: "contain" }} />
...
export default connect(mapStateToProps, mapDispatchToProps)(ListAssign)